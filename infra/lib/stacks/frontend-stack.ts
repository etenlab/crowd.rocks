...
export class FrontendStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: FrontendStackProps) {
    ...
    const assetsBucket = new s3.Bucket(
      this,
      `${props.appPrefix}${props.appId}WebsiteBucket`,
      {
    ...
    const cloudfrontDistribution = new FrontendCloudfront(
      this,
      `${props.appPrefix}${props.appId}Cfn`,
      {
    ...
    new cdk.CfnOutput(this, `${props.appPrefix}${props.appId}BucketName`, {
      exportName: `${props.appId}-bucket-name`,
      value: assetsBucket.bucketName,
    });

    new cdk.CfnOutput(this, `${props.appPrefix}${props.appId}CloudfrontId`, {
      exportName: `${props.appId}-distribution-id`,
      value: cloudfrontDistribution.distributionId,
    });

    new cdk.CfnOutput(this, `${props.appPrefix}${props.appId}DomainName`, {
