create or replace procedure batch_word_to_phrase_translation_upsert(
  in p_from_word_definition_ids bigint[],
  in p_to_phrase_definition_ids bigint[],
  in p_token varchar(512),
  inout p_word_to_phrase_translation_ids bigint[],
...
declare
  ...
  v_temp_word_to_phrase_translation_id bigint;
...
begin
  ...
  for i in 1..v_from_word_definition_ids_length loop
    ...
    p_word_to_phrase_translation_ids := array_append(
      p_word_to_phrase_translation_ids, 
      v_temp_word_to_phrase_translation_id
    );
