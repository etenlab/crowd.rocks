create or replace procedure word_to_phrase_translation_vote_reset(
...
begin
  ...
  -- check for word_to_phrase_translation existance
  ...
  values (p_word_to_phrase_translation_id, v_user_id, null)
