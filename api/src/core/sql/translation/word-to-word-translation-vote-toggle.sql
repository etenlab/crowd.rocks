create or replace procedure word_to_word_translation_vote_toggle(
  in p_word_to_word_translation_id bigint,
  in p_vote boolean,
  in p_token varchar(512),
  inout p_word_to_word_translation_vote_id bigint,
...
begin
  ...
  -- validate inpus
  if p_word_to_word_translation_id is null or p_vote is null then
