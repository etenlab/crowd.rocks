drop procedure if exists phrase_to_phrase_translation_upsert(
...
begin
  ...
  -- validate inpus
  if p_from_phrase_definition_id is null or p_to_phrase_definition_id is null then
  ...
  insert into phrase_to_phrase_translations(from_phrase_definition_id, to_phrase_definition_id, created_by)
  values (p_from_phrase_definition_id, p_to_phrase_definition_id, v_user_id)
