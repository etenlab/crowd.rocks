create or replace procedure phrase_to_phrase_translation_vote_toggle(
...
begin
  ...
  -- validate inpus
  if p_phrase_to_phrase_translation_id is null or p_vote is null then
  ...
  where phrase_to_phrase_translation_id = v_phrase_to_phrase_translation_id
