...
as $$
declare
  v_word_to_word_translation_ids_length int;

  v_temp_word_to_word_translation_vote_id bigint;
  v_temp_error_type varchar(32);
begin
  -- validate inputs

  v_word_to_word_translation_ids_length := array_length(
    p_word_to_word_translation_ids::bigint[], 1
  );
  ...
  for i in 1..v_word_to_word_translation_ids_length loop
    ...
    p_word_to_word_translation_vote_ids := array_append(
      p_word_to_word_translation_vote_ids, 
      v_temp_word_to_word_translation_vote_id
    );
