...
drop procedure if exists batch_document_word_entry_upsert;
...
begin
  ...
  v_pages_length := array_length(p_pages::bigint[], 1);

  if v_document_ids_length != v_wordlike_string_ids_length or
    v_document_ids_length != v_parent_document_word_entry_ids_length or
    v_document_ids_length != v_pages_length
  then
