drop procedure if exists original_map_vote_toggle;
create or replace procedure original_map_vote_toggle(
  in p_map_id bigint,
  in p_vote boolean,
...
begin
  ...
  -- check for original_map existance
  v_map_id := null;
