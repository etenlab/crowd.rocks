...
from
  original_maps
where
  original_map_file_name = p_map_file_name into v_current_map_id;
...
values
  (
    ...
    p_map_content,
    v_user_id
  ) on conflict do nothing returning original_map_id into p_original_map_id;
