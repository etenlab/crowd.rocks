...
// import './PostRead.css';
// import { get_cardinal_suffix } from '../../common/utility';
...
const PostRead: React.FC<PropsWithChildren<PostReadProps>> = () => {
  ...
  //     set_active_post({
  //       ...res.data.postReadResolver.post,
  //       rank: 0, // Provide the value for rank here
  //     });
  //   }
  // };
