...
export type Mutation = {
  ...
  siteTextLanguageUpsert: SiteTextLanguageOutput;
...
export type MutationSiteTextLanguageUpsertArgs = {
...
export type Query = {
  ...
  getSiteTextLanguage: SiteTextLanguageOutput;
...
export type QueryGetSiteTextLanguageArgs = {
  id: Scalars['ID']['input'];
};
...
export type SiteTextLanguage = {
  ...
  site_text_language_id: Scalars['ID']['output'];
};
...
export type SiteTextLanguageOutput = {
  __typename?: 'SiteTextLanguageOutput';
  error: ErrorType;
  site_text_language?: Maybe<SiteTextLanguage>;
};

export type SiteTextLanguageUpsertInput = {
  dialect_code?: InputMaybe<Scalars['String']['input']>;
  geo_code?: InputMaybe<Scalars['String']['input']>;
  language_code: Scalars['String']['input'];
};
...
export type GetSiteTextLanguageListQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetSiteTextLanguageListQuery = {
  __typename?: 'Query';
...
export type ToggleVoteStatusMutationOptions = Apollo.BaseMutationOptions<
  ...
  ToggleVoteStatusMutationVariables
>;
export const GetSiteTextLanguageListDocument = gql`
...
/**
 * __useGetSiteTextLanguageListQuery__
 *
 * To run a query within a React component, call `useGetSiteTextLanguageListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetSiteTextLanguageListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetSiteTextLanguageListQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetSiteTextLanguageListQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetSiteTextLanguageListQuery,
    GetSiteTextLanguageListQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    GetSiteTextLanguageListQuery,
    GetSiteTextLanguageListQueryVariables
  >(GetSiteTextLanguageListDocument, options);
}
export function useGetSiteTextLanguageListLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetSiteTextLanguageListQuery,
    GetSiteTextLanguageListQueryVariables
  >,
...
export type GetSiteTextLanguageListQueryHookResult = ReturnType<
  typeof useGetSiteTextLanguageListQuery
>;
export type GetSiteTextLanguageListLazyQueryHookResult = ReturnType<
  typeof useGetSiteTextLanguageListLazyQuery
>;
export type GetSiteTextLanguageListQueryResult = Apollo.QueryResult<
  GetSiteTextLanguageListQuery,
  GetSiteTextLanguageListQueryVariables
>;
...
export const namedOperations = {
  Query: {
    ...
    GetSiteTextLanguageList: 'GetSiteTextLanguageList',
    UserRead: 'UserRead',
